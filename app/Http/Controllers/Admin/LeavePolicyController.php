...
class LeavePolicyController extends Controller
{
    public function index(): View
    {
        ...
        $policies = LeavePolicy::query()->with('leaveType')->orderByDesc('created_at')->get();

        return view('erp.admin.leave-policies', compact('leaveTypes', 'policies'));
    }
    ...
    public function activate(LeavePolicy $leavePolicy): RedirectResponse
    {
        ...
        return back()->with('status', 'leave-policy-activated');
    }
}
